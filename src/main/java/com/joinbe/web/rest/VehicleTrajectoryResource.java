...
//@RestController
@RequestMapping("/api")
public class VehicleTrajectoryResource {

    private static final String ENTITY_NAME = "vehicleTrajectory";
    private final Logger log = LoggerFactory.getLogger(VehicleTrajectoryResource.class);
    private final VehicleTrajectoryService vehicleTrajectoryService;
    @Value("${jhipster.clientApp.name}")
    private String applicationName;

    public VehicleTrajectoryResource(VehicleTrajectoryService vehicleTrajectoryService) {
